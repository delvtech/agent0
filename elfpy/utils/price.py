...
### Spot Price and APR ###
def calc_apr_from_spot_price(price: float, time_remaining: time.utils.StretchedTime):
    r"""
...
def calc_spot_price_from_apr(apr: float, time_remaining: time.utils.StretchedTime):

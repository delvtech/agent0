...
class YieldspacePricingModel(PricingModel):
    ...
    def calc_in_given_out(
        ...
        if out.unit == types.TokenType.BASE:
            ...
            assert base_of_exponent > 0, f"yieldspace.calc_in_given_out() ERROR: {base_of_exponent=} <= 0"
    ...
    def calc_out_given_in(
        ...
        if in_.unit == types.TokenType.BASE:
            ...
            assert base_of_exponent > 0, f"yieldspace.calc_out_given_in() ERROR: {base_of_exponent=} <= 0"

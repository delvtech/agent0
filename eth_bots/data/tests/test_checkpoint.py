...
from eth_bots.data.db_schema import Base, CheckpointInfo
...
class TestCheckpointInterface:
    ...
    def test_get_checkpoints(self, session):
        ...
        checkpoints_df = postgres.get_checkpoint_info(session)
    ...
    def test_block_query_checkpoints(self, session):
        ...
        checkpoints_df = postgres.get_checkpoint_info(session, end_block=1)
        ...
        checkpoints_df = postgres.get_checkpoint_info(session, start_block=1, end_block=-1)

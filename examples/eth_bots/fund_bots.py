...
if __name__ == "__main__":
    ...
    user_account = eth.accounts.EthAgent(private_key=user_key)
    ...
    agent_accounts = [eth.accounts.EthAgent(private_key=agent_private_key) for agent_private_key in agent_keys]

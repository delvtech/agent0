...
.. py:function:: get_years_remaining(market_time: float, mint_time: float, num_position_days: float) -> float
   ...
   :param num_position_days: Total duration of the token's term, in fractions of a year
   :type num_position_days: float

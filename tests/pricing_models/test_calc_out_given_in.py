    ...
    def test_calc_out_given_in_failure(self):
        ...
        failure_test_cases = [
            CalcOutGivenInFailureTestCase(
                ...
                time_remaining=time.utils.StretchedTime(days=91.25, time_stretch=1, normalizing_constant=365),
            ...
            CalcOutGivenInFailureTestCase(
                ...
                # days remaining > 365
                time_remaining=time.utils.StretchedTime(days=500, time_stretch=1, normalizing_constant=365),
                exception_type=AssertionError,
            ),
            CalcOutGivenInFailureTestCase(

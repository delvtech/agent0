...
class TestFixedPoint(unittest.TestCase):
    ...
    def test_init(self):
        ...
        # BEWARE: this is true because in python 5 == 5.0.  and int output of 5 from a FixedPoint
    ...
    def test_multiply(self):
        r"""Test `*` sugar for various type combos"""
        # INTS
        # multiply divides by 1e18, so this is 5 * 5 / 1e18 which rounds to zero

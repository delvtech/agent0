...
class TestFixedPointIntegerMath(unittest.TestCase):
    ...
    def test_add(self):
        ...
        assert FixedPointIntegerMath.add(FixedPointIntegerMath.ONE_18, 0) == FixedPointIntegerMath.ONE_18
        assert FixedPointIntegerMath.add(0, FixedPointIntegerMath.ONE_18) == FixedPointIntegerMath.ONE_18
        assert FixedPointIntegerMath.add(0, 0) == 0
    ...
    def test_sub(self):
        ...
        assert FixedPointIntegerMath.sub(FixedPointIntegerMath.ONE_18, FixedPointIntegerMath.ONE_18) == 0
        assert FixedPointIntegerMath.sub(FixedPointIntegerMath.ONE_18, 0) == FixedPointIntegerMath.ONE_18
        assert (
            FixedPointIntegerMath.sub(2 * FixedPointIntegerMath.ONE_18, FixedPointIntegerMath.ONE_18)
            == FixedPointIntegerMath.ONE_18
        )
        assert FixedPointIntegerMath.sub(0, 0) == 0
    ...
    def test_mul_up(self):
        ...
        assert FixedPointIntegerMath.mul_up(
        ...
        assert FixedPointIntegerMath.mul_up(369, 271) == 1
        assert FixedPointIntegerMath.mul_up(0, FixedPointIntegerMath.ONE_18) == 0
        assert FixedPointIntegerMath.mul_up(FixedPointIntegerMath.ONE_18, 0) == 0
        assert FixedPointIntegerMath.mul_up(0, 0) == 0
    ...
    def test_mul_down(self):
        ...
        assert FixedPointIntegerMath.mul_down(
            int(2.5 * FixedPointIntegerMath.ONE_18), int(0.5 * FixedPointIntegerMath.ONE_18)
        ) == int(1.25 * FixedPointIntegerMath.ONE_18)
        assert (
        ...
        assert FixedPointIntegerMath.mul_down(369, 271) == 0
        assert FixedPointIntegerMath.mul_down(0, FixedPointIntegerMath.ONE_18) == 0
        assert FixedPointIntegerMath.mul_down(FixedPointIntegerMath.ONE_18, 0) == 0
        assert FixedPointIntegerMath.mul_down(0, 0) == 0
    ...
    def test_div_down(self):
        ...
        assert FixedPointIntegerMath.div_down(
        ...
        assert FixedPointIntegerMath.div_down(2 * FixedPointIntegerMath.ONE_18, int(1e19 * 1e18)) == 0
        assert FixedPointIntegerMath.div_down(0, FixedPointIntegerMath.ONE_18) == 0
    ...
    def test_div_up(self):
        ...
        assert FixedPointIntegerMath.div_up(
            int(1.25 * FixedPointIntegerMath.ONE_18), int(0.5 * FixedPointIntegerMath.ONE_18)
        ) == int(2.5 * FixedPointIntegerMath.ONE_18)
        assert (
        ...
        assert FixedPointIntegerMath.div_up(2 * FixedPointIntegerMath.ONE_18, int(1e19 * 1e18)) == 1
        assert FixedPointIntegerMath.div_up(0, FixedPointIntegerMath.ONE_18) == 0
    ...
    def test_mul_div_down(self):
        ...
        assert FixedPointIntegerMath.mul_div_down(int(2.5e27), int(0.5e27), int(1e27)) == 1.25e27
        assert FixedPointIntegerMath.mul_div_down(int(2.5e18), int(0.5e18), int(1e18)) == 1.25e18
        assert FixedPointIntegerMath.mul_div_down(int(2.5e8), int(0.5e8), int(1e8)) == 1.25e8
        assert FixedPointIntegerMath.mul_div_down(369, 271, int(1e2)) == 999
        assert FixedPointIntegerMath.mul_div_down(int(1e27), int(1e27), int(2e27)) == 0.5e27
        assert FixedPointIntegerMath.mul_div_down(int(1e18), int(1e18), int(2e18)) == 0.5e18
        assert FixedPointIntegerMath.mul_div_down(int(1e8), int(1e8), int(2e8)) == 0.5e8
        assert FixedPointIntegerMath.mul_div_down(int(2e27), int(3e27), int(3e27)) == 2e27
        assert FixedPointIntegerMath.mul_div_down(int(2e18), int(3e18), int(3e18)) == 2e18
        assert FixedPointIntegerMath.mul_div_down(int(2e8), int(3e8), int(3e8)) == 2e8
        assert FixedPointIntegerMath.mul_div_down(0, int(1e18), int(1e18)) == 0
        assert FixedPointIntegerMath.mul_div_down(int(1e18), 0, int(1e18)) == 0
        assert FixedPointIntegerMath.mul_div_down(0, 0, int(1e18)) == 0
    ...
    def test_mul_div_up(self):
        ...
        assert FixedPointIntegerMath.mul_div_up(int(2.5e27), int(0.5e27), int(1e27)) == 1.25e27
        assert FixedPointIntegerMath.mul_div_up(int(2.5e18), int(0.5e18), int(1e18)) == 1.25e18
        assert FixedPointIntegerMath.mul_div_up(int(2.5e8), int(0.5e8), int(1e8)) == 1.25e8
        assert FixedPointIntegerMath.mul_div_up(369, 271, int(1e2)) == 1000
        assert FixedPointIntegerMath.mul_div_up(int(1e27), int(1e27), int(2e27)) == 0.5e27
        assert FixedPointIntegerMath.mul_div_up(int(1e18), int(1e18), int(2e18)) == 0.5e18
        assert FixedPointIntegerMath.mul_div_up(int(1e8), int(1e8), int(2e8)) == 0.5e8
        assert FixedPointIntegerMath.mul_div_up(int(2e27), int(3e27), int(3e27)) == 2e27
        assert FixedPointIntegerMath.mul_div_up(int(2e18), int(3e18), int(3e18)) == 2e18
        assert FixedPointIntegerMath.mul_div_up(int(2e8), int(3e8), int(3e8)) == 2e8
        assert FixedPointIntegerMath.mul_div_up(0, int(1e18), int(1e18)) == 0
        assert FixedPointIntegerMath.mul_div_up(int(1e18), 0, int(1e18)) == 0
        assert FixedPointIntegerMath.mul_div_up(0, 0, int(1e18)) == 0
    ...
    def test_ilog2(self):
        ...
        assert FixedPointIntegerMath.ilog2(0) == 0
        assert FixedPointIntegerMath.ilog2(1) == 0
        assert FixedPointIntegerMath.ilog2(2) == 1
        assert FixedPointIntegerMath.ilog2(3) == 1
        assert FixedPointIntegerMath.ilog2(4) == 2
        assert FixedPointIntegerMath.ilog2(8) == 3
        assert FixedPointIntegerMath.ilog2(16) == 4
        assert FixedPointIntegerMath.ilog2(32) == 5
        assert FixedPointIntegerMath.ilog2(64) == 6
        assert FixedPointIntegerMath.ilog2(128) == 7
        assert FixedPointIntegerMath.ilog2(256) == 8
        assert FixedPointIntegerMath.ilog2(512) == 9
        assert FixedPointIntegerMath.ilog2(1024) == 10
        assert FixedPointIntegerMath.ilog2(2048) == 11
        assert FixedPointIntegerMath.ilog2(4096) == 12
        assert FixedPointIntegerMath.ilog2(8192) == 13
        assert FixedPointIntegerMath.ilog2(16384) == 14
        assert FixedPointIntegerMath.ilog2(32768) == 15
        assert FixedPointIntegerMath.ilog2(65536) == 16
        assert FixedPointIntegerMath.ilog2(131072) == 17
        assert FixedPointIntegerMath.ilog2(262144) == 18
        assert FixedPointIntegerMath.ilog2(524288) == 19
        assert FixedPointIntegerMath.ilog2(1048576) == 20

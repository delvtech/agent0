...
class TestTimeUtils(unittest.TestCase):
    ...
    def test_time_conversion(self):
        ...
        self.assertEqual(test_time.time_conversion(time.TimeUnit.SECONDS), FixedPoint(2 * 31_556_952 * 10**18))
        self.assertEqual(test_time.time_conversion(time.TimeUnit.MINUTES), FixedPoint(2 * 525_600 * 10**18))
        self.assertEqual(test_time.time_conversion(time.TimeUnit.HOURS), FixedPoint(2 * 8_760 * 10**18))
        self.assertEqual(test_time.time_conversion(time.TimeUnit.DAYS), FixedPoint(2 * 365 * 10**18))
        self.assertEqual(test_time.time_conversion(time.TimeUnit.YEARS), FixedPoint(2 * 1 * 10**18))

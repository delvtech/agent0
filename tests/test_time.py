...
class TestTimeUtils(unittest.TestCase):
    ...
    def test_time_conversion(self):
        ...
        self.assertEqual(test_time.time_conversion(time.TimeUnit.SECONDS), FixedPoint("31_536_000.0"))
        ...
        self.assertEqual(test_time.time_conversion(time.TimeUnit.SECONDS), FixedPoint(2 * 31_536_000))

...
class TestCheckpointTable:
    ...
    def test_create_checkpoint(self, session):
        ...
        elf_simulations.data.hyperdrive.postgres.add_checkpoint_infos([checkpoint], session)
        session.commit()
...
class TestCheckpointInterface:
    ...
    def test_latest_block_number(self, session):
        ...
        elf_simulations.data.hyperdrive.postgres.add_checkpoint_infos([checkpoint_1], session)
        session.commit()
        ...
        elf_simulations.data.hyperdrive.postgres.add_checkpoint_infos([checkpoint_2, checkpoint_3], session)
    ...
    def test_get_checkpoints(self, session):
        ...
        elf_simulations.data.hyperdrive.postgres.add_checkpoint_infos(
            [checkpoint_1, checkpoint_2, checkpoint_3], session
        )

        checkpoints_df = elf_simulations.data.hyperdrive.postgres.get_checkpoint_info(session)
    ...
    def test_block_query_checkpoints(self, session):
        ...
        checkpoints_df = elf_simulations.data.hyperdrive.postgres.get_checkpoint_info(session, start_block=1)
        ...
        checkpoints_df = elf_simulations.data.hyperdrive.postgres.get_checkpoint_info(session, end_block=1)
        ...
        checkpoints_df = elf_simulations.data.hyperdrive.postgres.get_checkpoint_info(

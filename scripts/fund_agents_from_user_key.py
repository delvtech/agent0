...
from agent0.ethpy.hyperdrive import HyperdriveReadInterface, get_hyperdrive_addresses_from_uri
...
if __name__ == "__main__":
    ...
    hyperdrive_address = get_hyperdrive_addresses_from_uri(os.path.join(eth_config.artifacts_uri, "addresses.json"))[
        "erc4626_hyperdrive"
    ]

...
from agent0.ethpy.hyperdrive import get_hyperdrive_addresses_from_artifacts, get_hyperdrive_pool_config
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    if parsed_args.pool_addr == "":
        addresses = get_hyperdrive_addresses_from_artifacts(os.path.join(eth_config.artifacts_uri, "addresses.json"))

...
class HyperdrivePricingModel(YieldSpacePricingModel):
    ...
    def calc_in_given_out(
        ...
        .. note::
           ...
           and is modified in :ref:`elfpy.pricing_models.yieldspace.YieldSpacePricingModel.calc_lp_in_given_tokens_out`, :func:`elfpy.pricing_models.yieldspace.calc_tokens_out_given_lp_in`,

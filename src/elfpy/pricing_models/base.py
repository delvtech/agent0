...
class PricingModel(ABC):
    ...
    @abstractmethod
    def _calc_k_const(self, market_state: MarketState, time_remaining: StretchedTime | FrozenStretchedTime) -> Decimal:
    ...
    def calc_liquidity(
        ...
        target_apr: float,
        # TODO: Fields like time_remaining and fee_percent could arguably be

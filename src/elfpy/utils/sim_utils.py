...
def get_init_lp_agent(
    ...
    # get the reserve amounts for a small target liquidity to achieve target pool APR
    init_share_reserves, init_bond_reserves = pricing_model.calc_liquidity(

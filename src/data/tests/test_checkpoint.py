...
class TestCheckpointTable:
    ...
    def test_create_checkpoint(self, session):
        ...
        postgres_hyperdrive.add_checkpoint_infos([checkpoint], session)
        session.commit()
...
class TestCheckpointInterface:
    ...
    def test_latest_block_number(self, session):
        ...
        postgres_hyperdrive.add_checkpoint_infos([checkpoint_1], session)
        session.commit()
        ...
        postgres_hyperdrive.add_checkpoint_infos([checkpoint_2, checkpoint_3], session)
    ...
    def test_get_checkpoints(self, session):
        ...
        postgres_hyperdrive.add_checkpoint_infos([checkpoint_1, checkpoint_2, checkpoint_3], session)

        checkpoints_df = postgres_hyperdrive.get_checkpoint_info(session)
    ...
    def test_block_query_checkpoints(self, session):
        ...
        checkpoints_df = postgres_hyperdrive.get_checkpoint_info(session, start_block=1)
        ...
        checkpoints_df = postgres_hyperdrive.get_checkpoint_info(session, end_block=1)
        ...
        checkpoints_df = postgres_hyperdrive.get_checkpoint_info(session, start_block=1, end_block=-1)

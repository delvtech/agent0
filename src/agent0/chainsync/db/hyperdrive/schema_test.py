...
from .schema import DBCheckpointInfo, DBHyperdriveAddrToName, DBPoolConfig, DBPoolInfo
...
class TestHyperdriveAddrToNameTable:
    ...
    def test_create_hyperdrive_addr_to_name(self, db_session):
        """Create and entry"""
        addr_map = DBHyperdriveAddrToName(hyperdrive_address="1", name="a")
        db_session.add(addr_map)
        db_session.commit()

        retrieved_map = db_session.query(DBHyperdriveAddrToName).filter_by(hyperdrive_address="1").first()
    ...
    def test_update_hyperdrive_addr_to_name(self, db_session):
        ...
        updated_map = db_session.query(DBHyperdriveAddrToName).filter_by(hyperdrive_address="1").first()
    ...
    def test_delete_addr_to_username(self, db_session):
        ...
        deleted_map = db_session.query(DBHyperdriveAddrToName).filter_by(hyperdrive_address="1").first()
...
class TestCheckpointTable:
    ...
    def test_create_checkpoint(self, db_session: Session):
        ...
        checkpoint = DBCheckpointInfo(
            checkpoint_time=1, hyperdrive_address="a", block_number=1, vault_share_price=vault_share_price
        )
        db_session.add(checkpoint)
        db_session.commit()

        retrieved_checkpoint = db_session.query(DBCheckpointInfo).filter_by(checkpoint_time=1).first()
    ...
    def test_update_checkpoint(self, db_session: Session):
        ...
        updated_checkpoint = db_session.query(DBCheckpointInfo).filter_by(checkpoint_time=1).first()
    ...
    def test_delete_checkpoint(self, db_session: Session):
        ...
        deleted_checkpoint = db_session.query(DBCheckpointInfo).filter_by(checkpoint_time=1).first()
...
class TestPoolConfigTable:
    ...
    def test_create_pool_config(self, db_session: Session):
        ...
        retrieved_pool_config = db_session.query(DBPoolConfig).filter_by(hyperdrive_address="0").first()
    ...
    def test_delete_pool_config(self, db_session: Session):
        ...
        deleted_pool_config = db_session.query(DBPoolConfig).filter_by(hyperdrive_address="0").first()
...
class TestPoolInfoTable:
    ...
    def test_create_pool_info(self, db_session: Session):
        ...
        pool_info = DBPoolInfo(block_number=1, hyperdrive_address="a", timestamp=timestamp)
        db_session.add(pool_info)
        db_session.commit()

        retrieved_pool_info = db_session.query(DBPoolInfo).filter_by(block_number=1).first()
    ...
    def test_update_pool_info(self, db_session: Session):
        ...
        updated_pool_info = db_session.query(DBPoolInfo).filter_by(block_number=1).first()
    ...
    def test_delete_pool_info(self, db_session: Session):
        ...
        deleted_pool_info = db_session.query(DBPoolInfo).filter_by(block_number=1).first()

...
def fuzz_profit_check(chain_config: LocalChain.Config | None = None):
    ...
    long_agent_initial_balance = long_agent.get_pool_positions().balance.amount
    ...
    short_agent_initial_balance = short_agent.get_pool_positions().balance.amount
    ...
    check_data = {
        ...
        "long_agent_final_balance": long_agent.get_pool_positions().balance.amount,
        "long_events": {"open": open_long_event, "close": close_long_event},
        "short_trade_amount": short_trade_amount,
        "short_agent_final_balance": short_agent.get_pool_positions().balance.amount,

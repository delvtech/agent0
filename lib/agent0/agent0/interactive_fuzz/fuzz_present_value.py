...
def invariant_check(
    ...
    if not FixedPointMath.isclose(initial_lp_share_price, current_lp_share_price, abs_tol=test_tolerance):
    ...
    if check_data["trade_type"] in [
        ...
        if not FixedPointMath.isclose(initial_present_value, current_present_value, abs_tol=test_tolerance):
